...
namespace APIVerve.API.MarkdownLinkExtractor
{
    ...
    /// <summary>
    /// Client for the MarkdownLinkExtractor API
    /// </summary>
    public class MarkdownLinkExtractorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/markdownlinkextractor";
        ...
        {
            { "markdown", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public MarkdownLinkExtractorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdownLinkExtractorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdownLinkExtractorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MarkdownLinkExtractorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MarkdownLinkExtractorQueryOptions options)
        {
        ...
        public ResponseObj Execute(MarkdownLinkExtractorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MarkdownLinkExtractorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MarkdownLinkExtractorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MarkdownLinkExtractorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MarkdownLinkExtractorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MarkdownLinkExtractorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MarkdownLinkExtractorQueryOptions options)
        {
