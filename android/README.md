# Markdown Link Extractor Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:markdownlinkextractor-api:1.1.12'
}
```
...
```java
import com.apiverve.markdownlinkextractor.MarkdownLinkExtractorAPIClient;
import com.apiverve.markdownlinkextractor.APIResponse;
import com.apiverve.markdownlinkextractor.APIException;

// Initialize the client
MarkdownLinkExtractorAPIClient client = new MarkdownLinkExtractorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/markdownlinkextractor](https://docs.apiverve.com/ref/markdownlinkextractor)
...
- **Documentation:** [https://docs.apiverve.com/ref/markdownlinkextractor](https://docs.apiverve.com/ref/markdownlinkextractor)
- **Issues:** [GitHub Issues](https://github.com/apiverve/markdownlinkextractor-api/issues)
