# Markdown Link Extractor API - Examples

This folder contains example code for using the Markdown Link Extractor API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/markdownlinkextractor',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/markdownlinkextractor");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/markdownlinkextractor](https://docs.apiverve.com/ref/markdownlinkextractor)
