...
class TestMarkdownlinkextractorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = MarkdownlinkextractorAPIClient(self.api_key)

    @patch('apiverve_markdownlinkextractor.apiClient.requests.get')
