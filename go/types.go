// Package markdownlinkextractor provides a Go client for the Markdown Link Extractor API.
//
// For more information, visit: https://apiverve.com/marketplace/markdownlinkextractor?utm_source=go&utm_medium=readme
package markdownlinkextractor
...
// Request contains the parameters for the Markdown Link Extractor API.
//
// Parameters:
//   - markdown (required): string - Markdown text to parse (max 100,000 characters)
type Request struct {
...
// ResponseData contains the data returned by the Markdown Link Extractor API.
...
// LinksItem represents an item in the Links array.
...
// InternalData represents the internal object.
type InternalData struct {
	Count int `json:"count"`
	Links []interface{} `json:"links"`
}

// ExternalData represents the external object.
...
// EmailData represents the email object.
type EmailData struct {
	Count int `json:"count"`
	Links []interface{} `json:"links"`
}

// OtherData represents the other object.
