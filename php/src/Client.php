...
namespace APIVerve\Markdownlinkextractor;
...
/**
 * Client for the Markdown Link Extractor API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/markdownlinkextractor?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/markdownlinkextractor';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MarkdownlinkextractorClient] {$message}\n";
        }
    }
}
